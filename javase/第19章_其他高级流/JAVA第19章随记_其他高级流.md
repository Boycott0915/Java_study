...
![image-20251014110524523](JAVA第19章随记_其他高级流.assets/image-20251014110524523.png)
...
![image-20251014111538852](JAVA第19章随记_其他高级流.assets/image-20251014111538852.png)
...
![image-20251014144658672](JAVA第19章随记_其他高级流.assets/image-20251014144658672.png)
...
计算机要准确的存储和识别各种字符集符号，需要进行字符编码，一套字符集必然至少有一套字符编码。常见字符集有ASCII字符集、GBK字符集、Unicode字符集等。![](D:\BaiduNetdiskDownload\笔记\img\1_charset.jpg)
...
**转换流是字节与字符间的桥梁！**![](D:\BaiduNetdiskDownload\笔记\img\2_zhuanhuan.jpg)
...
反之，该字节序列还可以从文件中读取回来，重构对象，对它进行**反序列化**。`对象的数据`、`对象的类型`和`对象中存储的数据`信息，都可以用来在内存中创建对象。看图理解序列化： ![](D:\BaiduNetdiskDownload\笔记\img\3_xuliehua.jpg)
...
![image-20251015093845527](JAVA第19章随记_其他高级流.assets/image-20251015093845527.png)
...
![image-20251015095305074](JAVA第19章随记_其他高级流.assets/image-20251015095305074.png)

![image-20251015095438118](JAVA第19章随记_其他高级流.assets/image-20251015095438118.png)
...
![image-20251015100247917](JAVA第19章随记_其他高级流.assets/image-20251015100247917.png)

![image-20251015100300099](JAVA第19章随记_其他高级流.assets/image-20251015100300099.png)

![image-20251015100600180](JAVA第19章随记_其他高级流.assets/image-20251015100600180.png)

### 4.4 系统输出(sout)和打印流的关系

![image-20251015101536046](JAVA第19章随记_其他高级流.assets/image-20251015101536046.png)

![image-20251015101701155](JAVA第19章随记_其他高级流.assets/image-20251015101701155.png)
